...
public class HospedajeController {
	...
	@DeleteMapping("/lodging/delete/{id}/{type}")
	public ResponseEntity<Void> deleteLodging(@PathVariable int id, @PathVariable String type) {
		servicioHospedaje.deleteLodging(id, type);
		return ResponseEntity.noContent().build();
	}
